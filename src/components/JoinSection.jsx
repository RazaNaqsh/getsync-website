  ...
  return (
    <section className="pb-20">
      <div className="py-10 w-[85%] mx-auto">
        ...
        <p className="text-center text-[17px]  md:text-[20px] font-noto font-[500] ">
        ...
        <p className="hidden md:block text-center text-[17px]  md:text-[20px] font-noto font-[500]">
      ...
      <div>
        ...
        <div className="space-y-20">
          <div className="flex flex-col md:flex-row w-[85%] mx-auto justify-around">
            <div>
              <img src={join_1} alt="" />
            </div>
            <div className="md:w-[760px] md:h-[291px] bg-white border-[1px] border-r-[2px] border-b-[4px] border-black rounded-[10px] py-[12px] px-[30px] ">
              <div>
                <h2 className="text-[16px] md:text-[28px] text-center md:text-left font-semibold font-sans">
                  Students
                </h2>
              ...
              <button className="bg-[#A244C3] font-semibold text-white py-[5px] md:py-[10px] px-[16px] rounded-[5px] border-[1px] border-black border-r-[3px] border-b-[4px] block mx-auto mt-4">
                JOIN NOW
              </button>
            </div>
          </div>

          <div className="flex w-[85%]  flex-col-reverse md:flex-row  mx-auto  justify-around">
            <div className="md:w-[760px] md:h-[300px] bg-white border-[1px] border-r-[2px] border-b-[4px] border-black rounded-[10px] py-[12px] px-[30px]">
              <div>
                <h2 className="text-[16px] md:text-[28px] text-center md:text-left font-semibold font-sans">
                  Startups
                </h2>
              ...
              <button className="bg-[#A244C3] font-semibold text-white py-[5px] md:py-[10px] px-[16px] rounded-[5px] border-[1px] border-black border-r-[3px] border-b-[4px] block  mx-auto mt-8">
                JOIN NOW
              </button>
            </div>
            <div>
          ...
          <div className="flex w-[85%]  flex-col md:flex-row  mx-auto  justify-around">
            <div>
              <img src={join_3} alt="" />
            </div>
            <div className="md:w-[760px] md:h-[300px] bg-white border-[1px] border-r-[3px] border-b-[4px] border-black rounded-[10px] py-[12px] px-[30px]">
              <div>
                <h2 className="text-[16px] md:text-[28px] text-center md:text-left font-semibold font-sans">
                  Mentors
                </h2>
              ...
              <button className="bg-[#A244C3] font-semibold text-white py-[5px] md:py-[10px] px-[16px] rounded-[5px] border-[1px] border-black border-r-[3px] border-b-[4px] block mx-auto mt-2">
                JOIN NOW
              </button>
            </div>
          </div>
